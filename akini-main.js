...
document.addEventListener("DOMContentLoaded", function () {
  try {
    ...
    function o(t) {
      window.__navPush();
      ["settingsArea", "beautifyArea", "icityArea", "wordbankOverlay"].forEach(
        function (t) {
    ...
    (function () {
      ...
      function S(t, e) {
        localStorage.setItem(o, JSON.stringify({ left: t, right: e }));
      }
      ...
      window.akiniContacts = {
        ...
        tryRestoreFromBackup: function (a) {
          ...
          function mergeSessions(cur, idb) {
            ...
            for (var k in idb)
              idb.hasOwnProperty(k) && !merged[k] && (merged[k] = idb[k]);
            return merged;
          }
    ...
    function d(t) {
      if (
        !(function () {
          const t = document.getElementById("readReceiptToggle");
          return !t || t.classList.contains("on");
        })()
      )
        return "";
      return `<div style="display:flex;justify-content:${"right" === t ? "flex-end" : "flex-start"};padding-right:${"right" === t ? "46px" : "0"};padding-left:${"left" === t ? "46px" : "0"};margin-top:2px;"><span style="font-size:10px;color:#aaa;">已读</span></div>`;
    }
    function __akiniMarkLastRead(t) {
      try {
        var chatBody = document.getElementById("chatBody");
        if (!chatBody) return;
        var lastRow = chatBody.lastElementChild;
        if (!lastRow || lastRow.classList.contains("system")) return;
        var meta = lastRow.querySelector(".msg-meta");
        if (meta && meta.textContent.indexOf("已读") >= 0) return;
        if (!lastRow.classList.contains("me")) return;
        var receipt = document.createElement("div");
        receipt.style.cssText =
          "display:flex;justify-content:flex-end;padding-right:46px;margin-top:2px;";
        receipt.innerHTML =
          '<span style="font-size:10px;color:#aaa;">已读</span>';
        chatBody.appendChild(receipt);
    ...
    function f() {
      var n = localStorage.getItem("akini_my_avatar");
      if (n) {
    ...
    function y() {
      if (window.akiniContacts) {
        var ct = window.akiniContacts.getChatTarget(
          window.akiniContacts.getActiveChatId(),
        );
        if (ct && ct.avatar && ct.avatar.trim()) {
          window.__akiniAvatarCache.ta = ct.avatar;
          return it(ct.avatar, "🐰");
        }
      }
      var n = localStorage.getItem("akini_ta_avatar");
      if (n) {
    ...
    function w(t, a, o) {
      ...
      try {
        ...
        if (
          ...
          0 === w.length &&
          Math.random() <
            window.AKR.getProb("groupAtMe") + window.AKR.getProb("groupAtOther")
        ) {
          var x = r.memberIds ? r.memberIds.slice() : [];
          if (
            (x.push("me"),
            ...
            var __gaTotal =
              window.AKR.getProb("groupAtMe") +
              window.AKR.getProb("groupAtOther");
            var E =
              __gaTotal > 0 &&
              Math.random() < window.AKR.getProb("groupAtMe") / __gaTotal
                ? "me"
                : x.filter(function (t) {
                    return t !== "me";
                  })[
            ...
            var A =
              "me" === E
                ? g() || "我"
                : (window.akiniContacts.getChatTarget(E) || {}).name;
            A && ((w = [A]), (k = E));
          }
        }
        var B = w.length > 0 ? "@" + w.join(" @") + " " : "";
        if (
          (l || !s) &&
          (s
      ...
      setTimeout(function () {
        try {
          ...
          r === window.akiniContacts.getActiveChatId() &&
            ...
            h(),
            "function" == typeof hideTypingBubble && hideTypingBubble(r));
          var t = c;
          if (!t) {
    ...
    function showTypingBubble(t, memberId) {
      ...
      if (window.__akiniTypingMap[t]) return;
      if (document.getElementById("typingBubbleRow_" + t)) return;
    ...
    function I(t, e, n) {
      ...
      if (!picked || !picked.trim()) {
        var _wb = [];
        try {
          _wb = JSON.parse(localStorage.getItem("akini_wordbank") || "[]");
        } catch (e) {
          _wb = [];
        }
        _wb = _wb.filter(function (t) {
          var e = (t.tab || "").toLowerCase(),
            n = (t.type || "").toLowerCase();
          return "pat" !== e && "pat" !== n;
        });
        if (0 === _wb.length) {
          ...
          if (t === _ac || r === _ac) {
            var _sys =
              '<div class="msg-row system" style="display:flex!important;justify-content:center!important;padding:8px 0!important;"><div class="bubble" style="background:#f0f0f0!important;color:#888!important;padding:8px 16px!important;border-radius:8px!important;font-size:13px!important;display:block!important;visibility:visible!important;opacity:1!important;max-width:80%!important;box-shadow:0 1px 3px rgba(0,0,0,.08)!important;">字卡库为空，请先添加字卡</div></div>';
            if (U) {
      ...
      function doRecall() {
        if (!a || !U) return;
        var rows = U.querySelectorAll(".msg-row.other");
        ...
        setTimeout(
          function () {
            if (last.parentNode) {
              ...
              recallSys.innerHTML =
                '<div class="bubble">' + e.name + " 撤回了一条消息</div>";
              var contentSys = null;
              if (recalledText) {
                contentSys = document.createElement("div");
                contentSys.className = "msg-row system";
                contentSys.innerHTML =
                  '<div class="bubble" style="font-size:12px;color:#888">(' +
                  rt(recalledText) +
                  ")</div>";
              }
              last.replaceWith(recallSys);
              if (contentSys) {
                recallSys.insertAdjacentElement("afterend", contentSys);
              }
              S();
              window.akiniContacts.updateSession(t, {
                lastMsg: e.name + " 撤回了一条消息",
                lastTime: Date.now(),
                messagesHTML: U.innerHTML,
              });
              C(t, U.innerHTML);
      ...
      if (U && window.akiniContacts) {
        ...
        if (e) {
          ...
          if (window.__akiniTypingMap) {
            var __typing = window.__akiniTypingMap[e];
            __typing &&
              (__typing.timer && clearTimeout(__typing.timer),
              delete window.__akiniTypingMap[e]);
          }
        }
        var t = U.innerHTML;
      ...
      ((n.onload = function (t) {
        ...
        ((n.onload = function () {
          var i = document.createElement("canvas"),
            ...
            c = n.height;
          (r > c && r > o
            ? ((c = Math.round((c * o) / r)), (r = o))
            : c >= r && c > o && ((r = Math.round((r * o) / c)), (c = o)),
            (i.width = r),
            (i.height = c),
            a.drawImage(n, 0, 0, r, c));
          try {
            var l = i.toDataURL("image/jpeg", 0.85);
            (l.length > 1e5 && (l = i.toDataURL("image/jpeg", 0.6)), e(l));
          } catch (n) {
            e(t.target.result);
          }
        }),
            ...
            _idbStore.get("akini_chat_history_" + e, function (t) {
              ...
              n && n.length > (r ? r.length : 0)
                ...
                : _idbStore.get("akini_chat_history_backup_" + e, function (t) {
                    if (window.akiniContacts.getActiveChatId() !== e) return;
                    (n = tt(i, a, t || "")) && n.length > (r ? r.length : 0)
                      ? o(n)
                      : r || o("");
                  });
            });
    ...
    (function () {
      if (U && K) {
        var t = null,
          e = 0,
          n = 0;
        (U.addEventListener("touchstart", a, { passive: !0 }),
          U.addEventListener(
            "touchmove",
            function (a) {
              if (t) {
                var o = a.touches ? a.touches[0] : a;
                (Math.abs(o.clientX - e) > 10 ||
                  Math.abs(o.clientY - n) > 10) &&
                  i();
              }
            },
            { passive: !0 },
          ...
          U.addEventListener("touchcancel", i, { passive: !0 }),
          U.addEventListener("mousedown", a),
          U.addEventListener("mouseup", i),
      ...
      function a(a) {
        ...
        if (o) {
          ...
          if (r && r.classList.contains("group")) {
              ...
              ((e = l.clientX),
                ...
                (t = setTimeout(function () {
                  ...
                  if (t) {
                    var a = "@" + t + " ",
                      r = K.value,
                      c = K.selectionStart || 0;
                    K.value = r.slice(0, c) + a + r.slice(c);
                    var l = c + a.length;
    ...
    (Zt &&
      ...
      Zt.addEventListener("input", function () {
        if (((Zt.dataset.userEdited = "1"), window.akiniContacts)) {
          var t = window.akiniContacts.getActiveChatId();
          t && window.akiniContacts.updateContact(t, { name: this.value });
        }
        (Tn(),
          window.renderBeautifyContacts && window.renderBeautifyContacts(),
      ...
      Vt &&
        ...
        Vt.addEventListener("input", function () {
          ((Vt.dataset.userEdited = "1"),
            localStorage.setItem("akini_my_name", this.value),
            Tn());
        })));
    ...
    te &&
      ...
      te.addEventListener("input", function () {
        ((te.dataset.userEdited = "1"),
          Vt && ((Vt.value = this.value), (Vt.dataset.userEdited = "1")),
          localStorage.setItem("akini_my_name", this.value),
          Tn());
      }));
      ...
      plusMenu &&
        plusMenu.addEventListener("click", function (t) {
          ...
          if (e) {
            ...
            ("call" === n &&
              setTimeout(function () {
                var t = document.getElementById("callBtn");
                t && t.click();
              }, 0),
              "transfer" === n &&
                setTimeout(function () {
                  var t = document.getElementById("transferBtn");
                  t && t.click();
                }, 0),
              "image" === n &&
                setTimeout(function () {
                  var t = document.getElementById("fileInputImageSend");
                  t && t.click();
                }, 0),
              "survey" === n &&
                setTimeout(function () {
          ...
          S.addEventListener("change", function () {
            ...
            ((a.onload = function (i) {
              try {
                ...
                if (!p) return void alert("文件内容为空");
                let v = 0,
                  h = 0;
                const w = { main: 0, emoji: 0, pat: 0 },
                  k = l(),
                  _ = new Set(k.map((t) => (t.text || t.content || "").trim())),
                  b = d();
                function a(t, e) {
                  e = e || {};
                  var n,
                  ...
                  if (i && !_.has(i)) {
                    "string" == typeof t
                      ...
                      : (((n = Object.assign({}, t)).text = i),
                        !n.tab && e.tab && (n.tab = e.tab),
                        n.tab || (n.tab = "main"),
                        !n.gid && e.gid && (n.gid = e.gid));
                    k.push(n);
                    _.add(i);
                    v++;
                    w[n.tab] = (w[n.tab] || 0) + 1;
                ...
                if (I)
                  try {
                    ...
                    return void alert("JSON 解析失败：" + C.message);
                  }
                  ...
                  if (
                    (Array.isArray(x.customReplyGroups) &&
                      x.customReplyGroups.forEach((t) => {
                        if (!t || !t.name) return;
                        const e = Date.now() + Math.floor(1e6 * Math.random()),
                          n = [
                            "#38D9A9",
                            "#74C0FC",
                            "#FFA94D",
        ...
        (i.forEach((t, n) => {
          ...
          const i = (function (t) {
              if (!t.author || t.author === a)
                return localStorage.getItem("akini_my_avatar") || "🐻";
              if (window.akiniContacts) {
                if (t.authorId) {
          ...
          ((u.className = "post-item"),
            ...
            (u.innerHTML =
              ...
              })(t.date || new Date(t.ts).toLocaleString("zh-CN")) +
      ...
      (t && ((t.style.display = "flex"), (t.style.zIndex = "99999999")),
        ...
        (function () {
          ...
          if (t) {
            ...
            else if (we.isGroupCall && we.answered && we.activeMember) {
              var a = document.getElementById("callNameFull");
              a &&
                (a.innerText = we.activeMember.name || we.callerName || "群聊");
              var o = document.createElement("div");
              ((o.className = "call-avatar"),
                (o.style.cssText =
                ...
                (o.innerHTML = nt(we.activeMember.avatar, 100)),
                t.appendChild(o));
            } else {
      ...
      if (window.akiniContacts) {
        ...
        if (t) {
          var i =
              ...
              rt(e) +
              "</div></div>",
            a = (window.akiniContacts.getSession(t).messagesHTML || "") + i;
          if (
            (window.akiniContacts.updateSession(t, {
              messagesHTML: a,
              lastTime: Date.now(),
            ...
            C(t, a),
            V(),
            U && window.akiniContacts.getActiveChatId() === t)
          ) {
            var o = document.createElement("div");
            ((o.className = "msg-row system"),
              (o.innerHTML = '<div class="bubble">' + rt(e) + "</div>"),
              U.appendChild(o),
              (U.scrollTop = U.scrollHeight));
          }
          "function" == typeof ot && ot();
    ...
    function an(t, e, n, i, a) {
      ...
      const w = v + "_status",
        ...
        _ = (n || "")
          ...
          .replace(/</g, "&lt;")
          .replace(/>/g, "&gt;"),
        I = new Date().toLocaleString("zh-CN"),
        x =
          "me" === m
            ? g() || "我"
      ...
      (window._openTransferDetailFromBubble = function (t) {
        ...
        !(function (t) {
          ...
          ((i.textContent = "¥" + parseFloat(e.amount).toFixed(2)),
            ...
            (o.textContent = e.time || new Date().toLocaleString("zh-CN")),
    ...
    (function () {
      ...
      (document.addEventListener(
        ...
        document
          .getElementById("ctxRevoke")
          .addEventListener("click", function () {
            if (!n) return void a();
            const t = localStorage.getItem("akini_my_name") || "我",
              e = document.createElement("div");
            ((e.className = "msg-row system"),
              (e.innerHTML =
                '<div class="bubble">' + t + " 撤回了一条消息</div>"),
              n.replaceWith(e));
            const i = document.getElementById("chatBody");
            if (i)
              try {
                _idbStore.set("akini_chat_history", i.innerHTML);
              } catch (t) {}
            a();
          }),
        document
    ...
    (function () {
      function t() {
        !(function () {
          var t = localStorage.getItem("akini_my_avatar") || "🐱",
            e =
        ...
        if (n) {
          ...
          if (0 !== a.length) {
            var o = localStorage.getItem("akini_icity_my_nick") || "我",
              ...
              c = localStorage.getItem("akini_my_avatar") || "";
            a.slice()
              .sort(function (t, e) {
                return t.pinned && !e.pinned
                  ? -1
      ...
      function o(t) {
        ...
        if (c) {
          var l = t.comments || [],
            ...
            u = localStorage.getItem("akini_my_avatar") || "🐱",
        ...
        (window.openIcityDetail = function (t) {
          ...
          if (e && t) {
            ...
            if (r)
              ((n = c),
                (i = l),
                (a = localStorage.getItem("akini_my_avatar") || "🐱"));
            ...
            (v && (v.textContent = p.toLocaleString("zh-CN")), o(t));
              ...
              if (i) {
                ...
                if (!(r < 0)) {
                  var c =
                    ...
                    localStorage.getItem("akini_my_name") ||
                    "我";
                  var av = localStorage.getItem("akini_my_avatar") || "🐱";
    ...
    (Sn &&
      ...
      a(fn, function () {
        ...
        const e = localStorage.getItem("akini_my_name") || "我",
          n = In,
          a = i("akini_mail_sent", []);
        const sentDate = new Date().toLocaleString("zh-CN");
        (a.push({
          content: t,
          date: sentDate,
          from: e,
          ...
          mn && (mn.style.display = "none"),
          "sent" === kn && _n("sent"));
        const r = Dn(Math.floor(10 * Math.random()) + 1);
        if (r) {
          const e = parseFloat(
            ...
            (function (t) {
              ...
              if (window.akiniContacts) {
                var l = window.akiniContacts.getHomeAvatars(),
                  s = window.akiniContacts.getChatTarget(l.left),
                  d = window.akiniContacts.getChatTarget(l.right);
                (s && (r = { name: s.name, avatar: it(s.avatar, "🐻") }),
    ...
    function Dn(t) {
      return window.pickWordCards(t);
    }
    (Mn && Mn.addEventListener("input", Tn),
      Ln && Ln.addEventListener("input", Tn),
      Tn(),
      (function () {
        let t = 0,
          e = !1;
    ...
    ((function () {
      ...
      ((window.showInAppNotif = function (t) {
        ...
        if (n)
          try {
            ...
            var a = (t.msg || "").trim();
            var body = a;
            var d = new Notification(i, { body: body });
            d.onclick = function () {
      ...
      (function () {
          ...
          if (a && window.akiniContacts) {
            ...
            var i =
              "me" === e.right
                ...
                : "border:2px solid transparent;";
            ((n +=
              '<div style="display:flex;flex-direction:column;align-items:center;gap:4px;cursor:pointer;" data-slot-contact="me"><div style="width:42px;height:42px;border-radius:50%;background:#e8e8e8;overflow:hidden;display:flex;align-items:center;justify-content:center;' +
              i +
              '">' +
              nt(window.getMyAvatar ? window.getMyAvatar() : "🐻", 42) +
              '</div><div style="font-size:11px;color:#666;">我</div></div>'),
              (a.innerHTML = n),
              a.querySelectorAll("[data-slot-contact]").forEach(function (t) {
                t.addEventListener("click", function () {
                  var t = this.getAttribute("data-slot-contact"),
                    e = window.akiniContacts.getHomeAvatars();
                  ("left" === o ? (e.left = t) : (e.right = t),
                    e.left === e.right && "me" !== e.left && (e.left = "me"),
        ...
        function c() {
          if (window.akiniContacts) {
            ...
            (o && t && (t.innerHTML = nt(o.avatar, 56)),
              r && e && (e.innerHTML = nt(r.avatar, 56)),
              o && n && (n.textContent = o.name),
      ...
      (window.triggerTaReplyOnce = function (t, delay) {
        ...
        setTimeout(function () {
          (a && i && hideTypingBubble(t), I(t, e, n));
        }, s);
      }),
    ...
    (function () {
      ...
      function Tt(n, i, a) {
        ...
        return fetch(t + "?path=playlist/detail", {
          method: "POST",
          headers: { "Content-Type": "application/json" },
          body: JSON.stringify({ id: String(n), cookie: i }),
        })
          .then(function (t) {
            return t.json();
          })
      ...
      const t =
          "https://backend.appmiaoda.com/projects/supabase348126418363789312/functions/v1/netease-proxy",
        e = {
      ...
      function wt(e, n, i) {
        ...
        var o = t + "?path=song/url";
        return fetch(o, {
          method: "POST",
          headers: { "Content-Type": "application/json" },
          body: JSON.stringify({ id: String(e.id), cookie: a }),
        })
          .then(function (t) {
      ...
      function It() {
        ...
        (function (e) {
          function loadLyric(retryCount) {
            ...
            return fetch(t + "?path=lyric", {
              method: "POST",
              headers: { "Content-Type": "application/json" },
              body: JSON.stringify({ id: String(e) }),
            })
              .then(function (t) {
                return t.json();
              })
    ...
    ((window.I = I), (window.openChat = ct));
    console.log("[Akini] v20260913s build - DOMContentLoaded 执行完毕 ✅");
  } catch (__bootErr) {
